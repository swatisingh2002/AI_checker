...
if text_area is not None:
    if st.button("Analyze"):
        ...
        with col2:
            st.info("Detection Score(Perplexity Score and Brustiness Score)")
            ...
            if perplexity > 30000 and burstiness_score < 0.2:
                ...
                st.error("The perplexity score is more than 30000 for this content and the brustiness score is less than 0.2")
            else:
